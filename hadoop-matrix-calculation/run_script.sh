...
do
	...
	hadoop jar hadoop-examples-matrix-calculation.jar com.example.hadoop.MatrixCalc -D mapred.job.queue.name=default -D mapred.child.java.opts=-Xmx512m -D mapreduce.map.memory.mb=1024 -D mapreduce.map.gpu-memory.mb=1024  input output GPU
done
