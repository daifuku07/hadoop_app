#include <stdio.h>
#include "jni_CudaWrapper.h"

JNIEXPORT jint JNICALL Java_jni_CudaWrapper_CUDAProxy_1matrixAdd(JNIEnv *env, jobject obj, jfloatArray aArray, jfloatArray bArray, jfloatArray cArray)
{
		int i = 0;
		jsize N;
