...
JNIEXPORT jint JNICALL Java_com_example_jni_CudaWrapper_CUDAProxy_1matrixMul(JNIEnv *env, jobject obj, jintArray aArray, jintArray bArray, jintArray cArray, jint n, jint device_id)
{
	int i = 0, j = 0;
	jsize N = 0;
